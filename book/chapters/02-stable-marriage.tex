...
%% Status: drafted; 18 figures are still placeholders.
%%
...
%% (kept in material/notes/).  19 figures are still \figplaceholder boxes --
%% drop the artwork into book/figures/ and replace the placeholder line,
%% keeping the surrounding \caption and \label.  See book/figures/README.md.
...
\begin{figure}[ht]
\centering
\figplaceholder{55mm}{The instance of Example~\ref{ex:sm-main} drawn as a
...
\begin{figure}[ht]
\centering
\figplaceholder{60mm}{The cycle of Example~\ref{ex:sm-cycle} drawn as a directed
...
(Observation~\ref{obs:sm-3}); on the right, a woman's preference list with an
arrow moving strictly upward (Observation~\ref{obs:sm-2}). A caption such as
...
\begin{figure}[ht]
\centering
\figplaceholder{42mm}{The counting argument of Lemma~\ref{lem:sm-notstuck}.
...
\begin{figure}[ht]
\centering
\figplaceholder{45mm}{The two stable matchings of Example~\ref{ex:sm-2x2}, side
...
\begin{figure}[ht]
\centering
\figplaceholder{50mm}{The proof of Corollary~\ref{cor:sm-3}. Two panels. Left
panel, the Gale--Shapley output $\mu$: edge $m$--$w$, annotated ``$w$ is $m$'s
\emph{best} stable partner (Theorem~\ref{thm:sm-manoptimal})''. Right panel, the
