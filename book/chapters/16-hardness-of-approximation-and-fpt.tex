...
\begin{goals}
  \poolgoal{28.1}{define APX and approximation-preserving reductions}
  \poolgoal{28.2}{define an L-reduction and prove that L-reductions compose and preserve constant-factor approximability}
  ...
  \poolgoal{28.3}{state the PCP theorem and explain how it yields inapproximability results}
  \poolgoal{28.4}{define the W-hierarchy and W[1]-hardness, and give W[1]-hard problems}
  \poolgoal{28.5}{derive parameterized lower bounds from ETH}
\end{goals}
