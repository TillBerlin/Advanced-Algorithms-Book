...
\begin{goals}
  \poolgoal{27.1}{define tree decompositions and treewidth}
  \poolgoal{27.2}{determine the treewidth of trees, cycles and series--parallel graphs}
  ...
  \poolgoal{27.3}{design dynamic programming algorithms over a nice tree decomposition}
  \poolgoal{27.4}{state Courcelle's theorem and explain what it does and does not give you}
\end{goals}
