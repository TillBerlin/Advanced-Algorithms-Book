...
%% fig:sm-shapley, a photograph: Konrad Jacobs / MFO, CC BY-SA 2.0 DE.  Its
%% credit under the caption is required by that licence -- do not remove it,
%% and do not crop the image.  See book/figures/README.md.
...
algorithm proves --- and this is by far the simplest proof known --- that a
stable matching
always exists.
...
computation --- and the proof everyone gives is to run the Gale--Shapley
...
\begin{figure}[ht]
\centering
\includegraphics[height=38mm]{sm-shapley}
\caption[Lloyd Shapley (1923--2016).]{Lloyd Shapley (1923--2016), photographed
in Erlangen in 1980.\\[2pt]
{\footnotesize Photograph by Konrad Jacobs, Erlangen; copyright
Mathematisches Forschungsinstitut Oberwolfach, from the
\href{https://opc.mfo.de/detail?photoID=3808}{Oberwolfach Photo Collection}
(photo~3808). Reproduced unaltered under
\href{https://creativecommons.org/licenses/by-sa/2.0/de/deed.en}{CC BY-SA
2.0~DE}.}}
...
are. (The behaviour on random instances is strikingly asymmetric: the
proposing side's average partner rank stays around $\ln n$ while the other
side's grows like $n/\ln n$.)
\end{exercise}
