...
\begin{figure}[ht]
\centering
\figplaceholder{5.5cm}{A small graph $G$ of maximum degree $4$ beside its image
$G'$: four disjoint copies $G_1, \ldots, G_4$ drawn in a row, and for one vertex
$v$ of degree $2$ the two new vertices, each joined to all four copies
$v_1,\dots,v_4$.}
...
\begin{figure}[ht]
\centering
\figplaceholder{6cm}{Two colour classes $V_1$ and $V_2$ drawn as shaded blobs,
each a clique; $x_1,y_1$ hanging off $V_1$ and $x_2,y_2$ off $V_2$; one edge
$uv$ between the classes with its vertex $w_{uv}$ joined to everything in
$V_1 \cup V_2$ except $u$ and $v$.}
...
\emph{Condition \eqref{eq:lred-a}.} Any assignment satisfies at least half the
