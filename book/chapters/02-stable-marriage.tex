...
\begin{tikzpicture}[scale=1.0,
  ...
  \node[red!75!black,align=center] at (2.75,0.95)
    {$m$ prefers $w$ to $w'$};
  \node[red!75!black,align=center] at (1.25,0.35)
    {$w$ prefers $m$ to $m'$};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.9,
  ...
  \node[font=\footnotesize,align=center] at (3.5,-3.0)
        {and round\\ again};
  \draw[-{Latex[length=2mm]},black!55] (3.5,-3.75) arc (-90:200:0.62);
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1.0,
  ...
  \node at (0,0.35) {each prefers};
  \node at (0,-0.05) {the next};
...
\begin{tikzpicture}[scale=1.0,
  ...
  \node[red!75!black] at (1.7,0.65) {he is not interested};
  ...
  \node[red!75!black] at (9.3,0.65) {she is not interested};
\end{tikzpicture}
