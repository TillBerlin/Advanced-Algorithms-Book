...
\begin{goals}
  \goalitem{define approximation ratios for minimisation and maximisation problems}
  \goalitem{analyse greedy approximation algorithms and prove their ratios}
  \goalitem{give and analyse the $2$-approximation and Christofides' algorithm for metric \lang{TSP}}
