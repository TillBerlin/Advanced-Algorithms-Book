...
\begin{goals}
  \poolgoal{1.1}{define an Euler tour and show that every connected graph with all even degrees must have an Euler tour}
  \poolgoal{1.2}{define the stable marriage problem, blocking pairs and stable matchings}
  \poolgoal{1.3}{define the greedy algorithm and show that it might run forever}
  \poolgoal{1.4}{explain the Gale--Shapley algorithm and show that it returns a stable matching}
  \poolgoal{1.5}{define a men-optimal stable matching and show that Gale--Shapley returns one}
\end{goals}
