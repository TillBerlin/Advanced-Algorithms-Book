...
8  & Existential Theory of the Reals\rlap{$^\dagger$} & 7  & \cref{ch:etr}, \cref{ch:geometric-er} \\
9  & Exact Algorithm for Exact 3-SAT     & 8  & \cref{ch:exact-i} \\
10 & Bisection Width                     & 8  & \cref{ch:exact-i} \\
11 & Duality and geometric $\ER$-hardness\rlap{$^\ddagger$} & 9  & \cref{ch:geometric-er} \\
...
26 & The Landscape of Approximation Algorithms & 11 & \cref{ch:approx-ii} \\
...
$^\ddagger$ Question~11 has been revised: items~1--3 are withdrawn. See the
remark at the question itself.

$^\dagger$ Question~8 has been revised: items~4 and~6 are withdrawn and
items~7--10 are new. See the remark at the question itself. Item~5
(\lang{ETR-AM}) is answered in \cref{ch:geometric-er}, next to the other normal
form used there; everything else in Question~8 is answered in \cref{ch:etr}.
...
\paragraph{Question 26. The Landscape of Approximation Algorithms.}
