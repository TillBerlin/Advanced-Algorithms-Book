...
item~1 of pool question~1 and is not yet covered anywhere in the book.}
...
%==============================================================================
\begin{poolquestions}
  \poolq{1}{Stable Matchings}Item~1 (Euler tours) is \cref{sec:euler-tours},
  which is not written yet. Item~2 (the problem, blocking pairs, stable
  matchings) is \cref{sec:sm-model}; item~3 (a greedy algorithm that may run
  forever) is \cref{sec:sm-naive}; item~4 (Gale--Shapley and its correctness)
  is \cref{sec:sm-gs,sec:sm-analysis}; item~5 (men-optimality) is
  \cref{sec:sm-optimality}.
\end{poolquestions}
